...
export function Iphone({
  ...
  const themedClass = (lightClass: string, darkClass: string) => {
      ...
      >
        <g mask={hasMedia ? 'url(#screenPunch)' : undefined}>
          <path
            ...
            className={themedClass('fill-[#E5E5E5]', 'fill-[#404040]')}
          />
          <path
          ...
          <path
            ...
            className={themedClass('fill-white', 'fill-[#262626]')}
          />
        </g>
        ...
        <path
          ...
          className={themedClass(
            ...
            'fill-[#404040] stroke-[#404040] stroke-[0.5]'
          )}
        ...
        <path
          ...
          className={themedClass('fill-[#F5F5F5]', 'fill-[#262626]')}
        />
        <path
